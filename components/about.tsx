export function About() {
  return (
    <>
      {/* Divider */}
      <div className="h-2 bg-[#b8a988]" />
      
      <section id="over-ons" className="py-16 md:py-24 bg-[#c9b99a]">
        <div className="container mx-auto px-4 md:px-6 max-w-4xl text-center">
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-normal text-[#4a4538] mb-8 uppercase tracking-[0.15em] italic">
            Over ons
          </h2>
          <p className="text-[#4a4538] leading-relaxed text-sm md:text-base">
            ...
            Daarnaast geven we deskundig advies over de beste combinatie van vloeren en vloerverwarming, zodat je het 
            hele jaar door geniet van een warme en sfeervolle leefomgeving.
          </p>
        </div>
      </section>
    </>
